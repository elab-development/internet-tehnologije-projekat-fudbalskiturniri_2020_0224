...
import IgracModal from "../Modali/IgracModal/IgracModal";
  ...
  return (
    <div className="create-new-team-container">
      ...
      <form>
        ...
        <div className="input-container">
          <label>Mesto odakle je tim:</label>
          <input
            type="text"
            value={teamPlace}
            onChange={(e) => setTeamPlace(e.target.value)}
            placeholder="Unesi lokaciju tima"
            required
          />
        </div>
